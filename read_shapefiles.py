...
fn = '../data/deposits_new/Losm_mekt_checked_area_24_01_15.shp'
dep_thick = gpd.read_file(fn)
...
fn = '../data/ar50/ar50_hans.shp'
ar50 = gpd.read_file(fn)
ar50 = ar50.drop(columns=['arskogbon', 'artreslag', 'arjordbr', 'arveget', 'areal', 'arkartstd', 'kilde', 'Shape_Leng', 'Shape_Area'])
#ar50.crs
